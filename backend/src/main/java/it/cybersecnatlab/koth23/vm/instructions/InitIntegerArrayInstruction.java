...
public class InitIntegerArrayInstruction implements VMInstruction {
    VMRegistry registry;

    public InitIntegerArrayInstruction(JSONArray params, List<VMRegistry> registries) throws JSONException {
        if (params.length() != 1) {
    ...
    public void execute() throws VMException {
        registry.setData(new HashMap<Integer, Integer>());
    }
