...
public class NotInstruction implements VMInstruction {
    VMRegistry op1;
    VMRegistry op2;

    public NotInstruction(JSONArray params, List<VMRegistry> registries) throws JSONException {
        if (params.length() != 2) {
    ...
    public void execute() throws VMException {
        ...
        throw new VMException("Cannot not types!");
    }
