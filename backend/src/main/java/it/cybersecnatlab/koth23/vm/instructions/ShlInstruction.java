...
public class ShlInstruction implements VMInstruction {
    VMRegistry op1;
    VMInstructionParam op2;
    VMRegistry op3;

    public ShlInstruction(JSONArray params, List<VMRegistry> registries) throws JSONException {
        if (params.length() != 3) {
    ...
    public void execute() throws VMException {
        ...
        throw new VMException("Cannot shl types!");
    }
