...
public class JmpNEQ0Instruction implements VMInstruction {
    VMInstructionParam op1;
    VMRegistry cmpRegistry;

    public JmpNEQ0Instruction(JSONArray params, List<VMRegistry> registries, VMRegistry cmpRegistry) throws JSONException {
        if (params.length() != 1) {
