...
public class InitStringArrayInstruction implements VMInstruction {
    VMRegistry registry;

    public InitStringArrayInstruction(JSONArray params, List<VMRegistry> registries) throws JSONException {
        if (params.length() != 1) {
    ...
    public void execute() throws VMException {
        registry.setData(new HashMap<Integer, String>());
    }
