...
public class SarInstruction implements VMInstruction {
    VMRegistry op1;
    VMInstructionParam op2;
    VMRegistry op3;

    public SarInstruction(JSONArray params, List<VMRegistry> registries) throws JSONException {
        if (params.length() != 3) {
    ...
    public void execute() throws VMException {
        ...
        throw new VMException("Cannot sar types!");
    }
