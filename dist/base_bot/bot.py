                ...
                if ("entity" in map["map"][column][row]):
                    if (map["map"][column][row]["entity"]["type"] == "summoner"):
                        if (map["map"][column][row]["entity"]["id"] == self.id):
                            ...
                            my_life = map["map"][column][row]["entity"]["life"]
                            my_mana = map["map"][column][row]["entity"]["mana"]

        # Send randomly one of the four possible action
