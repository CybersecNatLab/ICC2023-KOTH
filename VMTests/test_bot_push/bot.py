...
class Bot():
    ...
    def move(self, map):
        ...
        if(random.randrange(20)==10):
            ...
            possible_destinations=[[my_location[0], my_location[1]-1], [my_location[0]-1, my_location[1]], [my_location[0], my_location[1]+1], [my_location[0]+1, my_location[1]]]
            possible_destinations=[x for x in possible_destinations if x[0]>=0 and x[0]<map['width'] and x[1]>=0 and x[1]<map['height']]
